...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2017 at 09:17 AM
...
(105, 'Badminton competition', 5, '\"There\'s no guarantee you\'ll be picked for a team or bought. Everyone has a base price and you enter into the auction, basically it\'s just a simple bidding war between the teams.', '\"There\'s no guarantee you\'ll be picked for a team or bought. Everyone has a base price and you enter into the auction, basically it\'s just a simple bidding war between the teams.\r\n\"I know it may not seem like a lot if you were involved in other sports - it\'s a weekly salary for some footballers - but it\'s huge for me and I have to grab all these opportunities while I can.\"', 'Group', 2, '2018-02-15', '09:00:00.000', '11:00:00.000', 10, 10, 50, 'Intermediate', 1),
...
INSERT INTO `user` (`user_ID`, `username`, `password`, `is_admin`, `email`, `phone_no`) VALUES
